...
При разработке использовались AI-инструменты для ускорения работы:
- Генерация структуры проекта и boilerplate-кода
- Шаблоны Pydantic-моделей и обработчиков ошибок
- Структура Postman-коллекции и документации
